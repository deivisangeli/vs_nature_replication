...
global overleaf "$path_overleaf/VS Replication Copy"
global figpath "$overleaf/Figures"
global tabpath "$overleaf/Tables"

// switches
	// audit
		local sumstats			        1 // table A1
		local balance			        1 // table A3
		local discrim			        1 // figs 3, 4, 5, A5
		local intensive			        1 // fig A6 and A7
		local conditions		        1 // fig 6
		local other_predictors	        1 // figs 2 and A8
		local detection	                1 // fig A9
		local tweet_type		        1 // table 3
		local pre_postGF				1 // fig 8 and A14
		local tabGF						1 // table 2
		local daily_signallers_2020     1 // fig A13
	// political contributions
		local fec_bars       		    1 // fig 1
	// donation experiment 
		local donations		        	1 // figs 7  and A12
		local infoloss	        		1 // fig 9
		local donationsumstats      	1 // table A2
	// high stakes
		local high_stakes         		1 // table 1 and A4
	// student survey
		local studentsumstats       	1 // table A5
		local predict_fig	   	        1 // fig 10
	// left twitter
		local left_twitter		        1 // figs A10 and A11
	...
	** Giving Gap for Black Profs **
	...
	if strpos("`outcome'","tweet")==0 {
		...
		preserve
			...
			graph export "$figpath/`outcome'_`treatment'_bysigBN`samp'.`img'", replace	
		restore	
	}
...
// use Data/analysis/main_audit_analysis, clear
use Data/audit_anon, clear
...
* Now get predictions
use Data\grad_survey_answers_anon
...
listtab * using "$tabpath/summarystats.tex", ///
	...
	"& \multicolumn{1}{c}{\textit{N = `Nsamp1'}} & \multicolumn{1}{c}{\textit{N = `Nsamp2'}} \\" ///
